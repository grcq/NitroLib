...
public class NextPageButton extends GUIButton {
    ...
    public NextPageButton(PaginatedGUI gui) {
        this(gui, "&aNext Page", Lists.newArrayList("&7Click to go to the next page"), Material.ARROW, (byte) 0);
    }

    public NextPageButton(PaginatedGUI gui, String name, List<String> lore) {
        this(gui, name, lore, Material.ARROW, (byte) 0);
    }

    public NextPageButton(PaginatedGUI gui, String name, List<String> lore, Material material) {
